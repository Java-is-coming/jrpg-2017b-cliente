...
public class EstadoDePersonaje {
	...
	public static void dibujarEstadoDePersonaje(Graphics g, int x, int y, NonPlayableCharacter npc, BufferedImage miniaturaPersonaje){
	...
	public static void dibujarEstadoDePersonaje(Graphics g, int x, int y, PaqueteNPC npc, BufferedImage miniaturaPersonaje){
		...
		g.setFont(new Font("Tahoma", Font.PLAIN, 10));
		g.drawImage(Recursos.barraSalud, x + 80, y + 26, ANCHOBARRA, ALTOSALUD, null);
		g.drawString(String.valueOf(npc.getSaludTope()) + " / " + String.valueOf(npc.getSaludTope()), x + 132, y + 37);

		/*
		g.drawImage(Recursos.barraEnergia, x + 80, y + 42, ANCHOBARRA, ALTOENERGIA, null);
		g.drawString(String.valueOf(npc.getEnergiaTope()) + " / " + String.valueOf(npc.getEnergiaTope()), x + 132, y + 52);
