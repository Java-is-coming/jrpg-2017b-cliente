...
public class EstadoDePersonaje {
    ...
    public static void dibujarEstadoDePersonaje(Graphics g, int x, int y, NonPlayableCharacter npc,
            BufferedImage miniaturaPersonaje) {
    ...
    public static void dibujarEstadoDePersonaje(Graphics g, int x, int y, PaqueteNPC npc,
            BufferedImage miniaturaPersonaje) {

        final int drawBarra = 0;
